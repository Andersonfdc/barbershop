<?php
    ...
    if(isset($_POST['updateAgenda'])){
            ...
            $sqlUpdateAgenda = "UPDATE usuarios SET barbeiro= '$barbeiro',servico='$servico',dataHora='$dataHora'
            WHERE idusuarios=$id";

            $result = $conexao->query($sqlUpdateAgenda);
            ...
            CURLOPT_POSTFIELDS =>"{\r\n  \"to\": \"+558399898887\",\r\n  \"type\": \"text\",\r\n  \"text\": {\r\n      \"body\": \" A(o) clinete: *$nome*, gostaria de agendar o serviço: *$servico*, com o barbeiro: *$barbeiro*. Não esqueça de confirmar ou cancelar a reserva.\"\r\n  }\r\n}",
